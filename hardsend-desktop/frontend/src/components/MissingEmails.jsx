...
function MissingEmails({ onBack }) {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            const res = await fetch(
                `${API_BASE}/api/missing-emails?period=${period}&show_resolved=${showResolved}`,
    ...
    const handleResolve = async (ids, all = false) => {
        ...
        try {
            ...
            const res = await fetch(`${API_BASE}/api/missing-emails/resolve`, {
                method: 'POST',
                headers: {
    ...
    const handleExport = () => {
        const url = `${API_BASE}/api/missing-emails/export?period=${period}&show_resolved=${showResolved}`
